...
2. [Vad är för- och nackdelar av RDF kontra XML?](#rdf-kontra-xml)
...
Det är naturligt att kvaliten varierar mellan datakällor då ansvariga organisationer lägger olika vikt vid sina data. Dessutom är det stor skillnad mellan datakällor som skapas på frivillig basis (t.ex. crowdsourcing) och de som ges ut av organisationer med avlönade experter.
...
Ibland kan också länkade data plattformar erbjuda färdiga gränsnittskomponenter, t.ex. för att lista, söka eller presentera enskilda resurser. Det är möjligt att sådana komponenter kan inkorporeras med en mindre insats (fixa enhetligt utseende via teman eller ren css) på samma sätt som man bäddar in t.ex. youtube klipp.
